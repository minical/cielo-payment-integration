<div class="page-header">
    <h2><?php echo l('cielo-payment-integration/payment gateway settings'); ?></h2>
</div>
...
<div class="form-horizontal" style="min-height: 165px;">
    <div class="form-group">
        <label for="current_time" class="col-sm-3 control-label">
            <?php echo l('cielo-payment-integration/Current Payment Gateway'); ?>
        </label>
        <div class="col-sm-9">
    ...
    <div class="col-sm-12 text-center">
        <div class="btn btn-light" id="update-button"><?php echo l('cielo-payment-integration/Update'); ?></div>
    </div>
</div>  
